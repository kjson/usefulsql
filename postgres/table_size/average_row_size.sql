-- Get average row sizes for a table
-- you must specify public.tbl
--
-- Credit Erwin Brandstetter  - http://dba.stackexchange.com/questions/23879/measure-the-size-of-a-postgresql-table-row
